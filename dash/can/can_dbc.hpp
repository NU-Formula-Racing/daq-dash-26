...
CAN_Signal_UINT32 ahCharged = MakeSignalExp(uint32_t, 32, 32, 0.0001, 0.0, true);
...
CAN_Signal_UINT32 whDrawn = MakeSignalExp(uint32_t, 0, 32, 0.001, 0.0, true);
CAN_Signal_UINT32 whCharged = MakeSignalExp(uint32_t, 32, 32, 0.001, 0.0, true);
...
CAN_Signal_UINT8 faultCode = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT8 bmsCommand = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT8 driveState = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT8 frontPumpDutyCycle = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 rearPumpDutyCycle = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 frontFanDutyCycle = MakeSignalExp(uint8_t, 16, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 rearFanDutyCycle = MakeSignalExp(uint8_t, 24, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT8 accelLutIdResponse = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT8 torqueStatus = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
RX_CAN_Message(1) ecuTorqueStatus{driveBus, 0x20C, torqueStatus};

}; // namespace ecuTorqueStatus

namespace cmRequestDrivetrain { 

CAN_Signal_UINT8 ecuEnableResponse = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 bmsEnableResponse = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 pdmEnableResponse = MakeSignalExp(uint8_t, 16, 8, 1.0, 0.0, true);
RX_CAN_Message(3) cmRequestDrivetrain{driveBus, 0x490, ecuEnableResponse, bmsEnableResponse, pdmEnableResponse};

}; // namespace cmRequestDrivetrain

namespace cmRequestDaq { 

CAN_Signal_UINT8 dynamicsEnableResponse = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 frontEnableResponse = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 telemetryEnableResponse = MakeSignalExp(uint8_t, 16, 8, 1.0, 0.0, true);
RX_CAN_Message(3) cmRequestDaq{driveBus, 0x491, dynamicsEnableResponse, frontEnableResponse, telemetryEnableResponse};

}; // namespace cmRequestDaq

namespace cmRequestWheel { 

CAN_Signal_UINT8 blEnableResponse = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 brEnableResponse = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 flEnableResponse = MakeSignalExp(uint8_t, 16, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 frEnableResponse = MakeSignalExp(uint8_t, 24, 8, 1.0, 0.0, true);
RX_CAN_Message(4) cmRequestWheel{driveBus, 0x492, blEnableResponse, brEnableResponse, flEnableResponse, frEnableResponse};

}; // namespace cmRequestWheel

namespace cmResponseEcu { 

CAN_Signal_UINT64 counter = MakeSignalExp(uint64_t, 0, 64, 1.0, 0.0, true);
RX_CAN_Message(1) cmResponseEcu{driveBus, 0x590, counter};

}; // namespace cmResponseEcu

namespace cmResponseBms { 
...
namespace cmNodeStatusDrivetrain { 

CAN_Signal_UINT8 ecuStatus = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 bmsStatus = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 pdmStatus = MakeSignalExp(uint8_t, 16, 8, 1.0, 0.0, true);
RX_CAN_Message(3) cmNodeStatusDrivetrain{driveBus, 0x192, ecuStatus, bmsStatus, pdmStatus};

}; // namespace cmNodeStatusDrivetrain

namespace cmNodeStatusDaq { 

CAN_Signal_UINT8 dynamicsStatus = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 frontStatus = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 telemetryStatus = MakeSignalExp(uint8_t, 16, 8, 1.0, 0.0, true);
RX_CAN_Message(3) cmNodeStatusDaq{driveBus, 0x193, dynamicsStatus, frontStatus, telemetryStatus};

}; // namespace cmNodeStatusDaq

namespace cmNodeStatusWheel { 

CAN_Signal_UINT8 blStatus = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 brStatus = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 flStatus = MakeSignalExp(uint8_t, 16, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 frStatus = MakeSignalExp(uint8_t, 24, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT8 totalPecFailures = MakeSignalExp(uint8_t, 10, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT8 bmsState = MakeSignalExp(uint8_t, 0, 8, 1.0, 0.0, true);
CAN_Signal_UINT8 imdState = MakeSignalExp(uint8_t, 8, 8, 1.0, 0.0, true);
...
CAN_Signal_UINT64 controllerError = MakeSignalExp(uint64_t, 0, 64, 1.0, 0.0, true);
...
CAN_Signal_UINT64 controllerErrorNack = MakeSignalExp(uint64_t, 0, 64, 1.0, 0.0, true);
...
CAN_Signal_UINT64 controllerErrorProtocolViolation = MakeSignalExp(uint64_t, 0, 64, 1.0, 0.0, true);
