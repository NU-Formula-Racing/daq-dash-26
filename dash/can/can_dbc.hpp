...
inline RX_CAN_Message(3) message{driveBus, 0x2A3, false, 6, coolant1Volt, coolant2Volt, coolant3Volt};
...
inline CAN_Signal_INT32 setCurrentFrontLeftInverter = MakeSignalSigned(int32_t, 0, 32, 0.001, 0.0, false);
...
inline CAN_Signal_INT32 setCurrentBrakeFrontLeftInverter = MakeSignalSigned(int32_t, 0, 32, 0.001, 0.0, false);
...
inline CAN_Signal_INT32 setCurrentFrontRightInverter = MakeSignalSigned(int32_t, 0, 32, 0.001, 0.0, false);
...
inline CAN_Signal_INT32 setCurrentBrakeFrontRightInverter = MakeSignalSigned(int32_t, 0, 32, 0.001, 0.0, false);
...
inline CAN_Signal_INT32 setCurrentRearInverter = MakeSignalSigned(int32_t, 0, 32, 0.001, 0.0, false);
...
inline CAN_Signal_INT32 setCurrentBrakeRearInverter = MakeSignalSigned(int32_t, 0, 32, 0.001, 0.0, false);
...
inline RX_CAN_Message(7) message{driveBus, 0x211, false, 1, highCurrent, hardBrake, brakeError, currentError, bspdShutdownB, bspdErrorB, bspdSensErrorB};
...
inline RX_CAN_Message(4) message{driveBus, 0x151, false, 8, batteryVoltage, maxCellVoltage, minCellVoltage, batteryTemperature};
...
inline RX_CAN_Message(17) message{driveBus, 0x152, false, 7, soc, bmsState, imdState, internalfaultSummary, undervoltageFault, overvoltageFault, undertemperatureFault, overtemperatureFault, openWireFault, openWireTempFault, pecFault, shutdownOpen, vcuTimeout, inverterTimeout, chargerTimeout, pecWarning, totalPecFailures};
...
inline RX_CAN_Message(8) message{driveBus, 0x170, false, 8, cellT1, cellT2, cellT3, cellT4, cellT5, cellT6, cellT7, cellT8};
...
inline RX_CAN_Message(8) message{driveBus, 0x171, false, 8, cellT9, cellT10, cellT11, cellT12, cellT13, cellT14, cellT15, cellT16};
...
inline RX_CAN_Message(8) message{driveBus, 0x172, false, 8, cellT17, cellT18, cellT19, cellT20, cellT21, cellT22, cellT23, cellT24};
...
inline RX_CAN_Message(8) message{driveBus, 0x173, false, 8, cellT25, cellT26, cellT27, cellT28, cellT29, cellT30, cellT31, cellT32};
...
inline RX_CAN_Message(8) message{driveBus, 0x174, false, 8, cellT33, cellT34, cellT35, cellT36, cellT37, cellT38, cellT39, cellT40};
...
inline RX_CAN_Message(8) message{driveBus, 0x175, false, 8, cellT41, cellT42, cellT43, cellT44, cellT45, cellT46, cellT47, cellT48};
...
inline RX_CAN_Message(8) message{driveBus, 0x176, false, 8, cellT49, cellT50, cellT51, cellT52, cellT53, cellT54, cellT55, cellT56};
...
inline RX_CAN_Message(8) message{driveBus, 0x177, false, 8, cellT57, cellT58, cellT59, cellT60, cellT61, cellT62, cellT63, cellT64};
...
inline RX_CAN_Message(8) message{driveBus, 0x178, false, 8, cellT65, cellT66, cellT67, cellT68, cellT69, cellT70, cellT71, cellT72};
...
inline RX_CAN_Message(8) message{driveBus, 0x179, false, 8, cellT73, cellT74, cellT75, cellT76, cellT77, cellT78, cellT79, cellT80};
...
inline RX_CAN_Message(8) message{driveBus, 0x17A, false, 8, cellT81, cellT82, cellT83, cellT84, cellT85, cellT86, cellT87, cellT88};
...
inline RX_CAN_Message(8) message{driveBus, 0x17B, false, 8, cellT89, cellT90, cellT91, cellT92, cellT93, cellT94, cellT95, cellT96};
...
inline RX_CAN_Message(4) message{driveBus, 0x530, false, 8, brTireTemp0, brTireTemp1, brTireTemp2, brTireTemp3};
...
inline RX_CAN_Message(4) message{driveBus, 0x531, false, 8, brTireTemp4, brTireTemp5, brTireTemp6, brTireTemp7};
...
inline CAN_Signal_INT32 brStrainGaugeUncalibrated = MakeSignalSigned(int32_t, 0, 32, 1.0, 0.0, false);
inline CAN_Signal_UINT32 brSusPotUncalibrated = MakeSignalExp(uint32_t, 32, 32, 1.0, 0.0);
inline RX_CAN_Message(2) message{driveBus, 0x538, false, 8, brStrainGaugeUncalibrated, brSusPotUncalibrated};
...
inline RX_CAN_Message(4) message{driveBus, 0x540, false, 8, brStrainGaugeError, brSusPotError, brTireTempError, brHeartbeatCount};
...
inline RX_CAN_Message(2) message{driveBus, 0x570, false, 8, brStrainGaugeCalibrated, brSusPotCalibrated};
...
inline RX_CAN_Message(4) message{driveBus, 0x532, false, 8, blTireTemp0, blTireTemp1, blTireTemp2, blTireTemp3};
...
inline RX_CAN_Message(4) message{driveBus, 0x533, false, 8, blTireTemp4, blTireTemp5, blTireTemp6, blTireTemp7};
...
inline CAN_Signal_INT32 blStrainGaugeUncalibrated = MakeSignalSigned(int32_t, 0, 32, 1.0, 0.0, false);
inline CAN_Signal_UINT32 blSusPotUncalibrated = MakeSignalExp(uint32_t, 32, 32, 1.0, 0.0);
inline RX_CAN_Message(2) message{driveBus, 0x53A, false, 8, blStrainGaugeUncalibrated, blSusPotUncalibrated};
...
inline RX_CAN_Message(4) message{driveBus, 0x541, false, 8, blStrainGaugeError, blSusPotError, blTireTempError, blHeartbeatCount};
...
inline RX_CAN_Message(2) message{driveBus, 0x571, false, 8, blStrainGaugeCalibrated, blSusPotCalibrated};
...
inline RX_CAN_Message(4) message{driveBus, 0x534, false, 8, frTireTemp0, frTireTemp1, frTireTemp2, frTireTemp3};
...
inline RX_CAN_Message(4) message{driveBus, 0x535, false, 8, frTireTemp4, frTireTemp5, frTireTemp6, frTireTemp7};
...
inline CAN_Signal_INT32 frStrainGaugeUncalibrated = MakeSignalSigned(int32_t, 0, 32, 1.0, 0.0, false);
inline CAN_Signal_UINT32 frSusPotUncalibrated = MakeSignalExp(uint32_t, 32, 32, 1.0, 0.0);
inline RX_CAN_Message(2) message{driveBus, 0x53C, false, 8, frStrainGaugeUncalibrated, frSusPotUncalibrated};
...
inline RX_CAN_Message(4) message{driveBus, 0x542, false, 8, frStrainGaugeError, frSusPotError, frTireTempError, frHeartbeatCount};
...
inline RX_CAN_Message(2) message{driveBus, 0x572, false, 8, frStrainGaugeCalibrated, frSusPotCalibrated};
...
inline RX_CAN_Message(4) message{driveBus, 0x536, false, 8, flTireTemp0, flTireTemp1, flTireTemp2, flTireTemp3};
...
inline RX_CAN_Message(4) message{driveBus, 0x537, false, 8, flTireTemp4, flTireTemp5, flTireTemp6, flTireTemp7};
...
inline CAN_Signal_INT32 flStrainGaugeUncalibrated = MakeSignalSigned(int32_t, 0, 32, 1.0, 0.0, false);
inline CAN_Signal_UINT32 flSusPotUncalibrated = MakeSignalExp(uint32_t, 32, 32, 1.0, 0.0);
inline RX_CAN_Message(2) message{driveBus, 0x53E, false, 8, flStrainGaugeUncalibrated, flSusPotUncalibrated};
...
inline RX_CAN_Message(4) message{driveBus, 0x543, false, 8, flStrainGaugeError, flSusPotError, flTireTempError, flHeartbeatCount};
...
inline RX_CAN_Message(2) message{driveBus, 0x573, false, 8, flStrainGaugeCalibrated, flSusPotCalibrated};
...
inline RX_CAN_Message(3) message{driveBus, 0x550, false, 8, xAxisAcceleration, yAxisAcceleration, zAxisAcceleration};
...
inline RX_CAN_Message(3) message{driveBus, 0x552, false, 8, xAxisAngularRate, yAxisAngularRate, zAxisAngularRate};
...
inline CAN_Signal_DOUBLE positionLongitude = MakeSignalSigned(double, 21, 21, 0.00012208, 0.0, false);
inline CAN_Signal_DOUBLE positionAltutude = MakeSignalSigned(double, 42, 21, 0.00781312, 0.0, false);
inline RX_CAN_Message(3) message{driveBus, 0x553, false, 8, positionLatitude, positionLongitude, positionAltutude};
...
inline RX_CAN_Message(3) message{driveBus, 0x554, false, 8, xAxisVelocity, yAxisVelocity, zAxisVelocity};
...
inline RX_CAN_Message(3) message{driveBus, 0x555, false, 8, xAxisMagnetometer, yAxisMagnetometer, zAxisMagnetometer};
...
inline CAN_Signal_FLOAT noGXAxisAcceleration = MakeSignalSigned(float, 0, 21, 0.00012208, 0.0, false);
inline CAN_Signal_FLOAT noGYAxisAcceleration = MakeSignalSigned(float, 21, 21, 0.00012208, 0.0, false);
inline CAN_Signal_FLOAT noGZAxisAcceleration = MakeSignalSigned(float, 42, 21, 0.00012208, 0.0, false);
inline RX_CAN_Message(3) message{driveBus, 0x557, false, 8, noGXAxisAcceleration, noGYAxisAcceleration, noGZAxisAcceleration};
...
inline RX_CAN_Message(5) message{driveBus, 0x558, false, 5, insMode, gnssFix, insError, gnssHeadingIns, gnssCompass};
...
inline RX_CAN_Message(7) message{driveBus, 0x559, false, 8, utcYear, utcMonth, utcDay, utcHour, utcMinutes, utcSeconds, utcMilliseconds};
...
inline RX_CAN_Message(3) message{driveBus, 0x55A, false, 8, xAxisDeltaVelocity, yAxisDeltaVelocity, zAxisDeltaVelocity};
